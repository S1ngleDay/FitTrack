...
const styles = StyleSheet.create({
  ...
  heroUnit: { color: colors.textSecondary, fontSize: 24, fontFamily: 'Inter_600SemiBold' },
  ...
  routeCard: { backgroundColor: colors.cardBg, borderRadius: 24, padding: 20, marginHorizontal: 20, marginTop: 10 },
  ...
  routeTitle: { fontSize: 18, fontFamily: 'Inter_700Bold', color: colors.textPrimary },
  routeSubtitle: { fontSize: 13, color: colors.textSecondary, fontFamily: 'Inter_500Medium' },
